<%-- 
    Document   : festaCadastrar2
    Created on : 11/04/2020, 15:26:43
    Author     : João Pedro
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../custom/css/paginaDeCadastros/cadastroDeFesta/festaCadastrar2.css">
    </head>
    <body>
        <!-- NavBar -->
        ...
        <h3>Cadastro de Festa - Etapa 2</h3>
    </body>
</html>
