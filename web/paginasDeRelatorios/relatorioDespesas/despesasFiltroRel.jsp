<%-- 
    Document   : despesasFiltroRel
    Created on : 13/09/2020, 18:34:48
    Author     : João Pedro
--%>
        ...
        <div class="container my-5">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8">
                    ...
                    <form method="GET" action="relatorioDespesa">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-4">
                                <input type="text" class="form-control" minlength="10" id="periodoDespesa" name="periodoDespesa" placeholder="00/00/0000" required> 
                            </div>
                            ...
                            <div class="form-group col-lg-4">
                                <input type="text" class="form-control" minlength="10" id="periodoDespesa2" name="periodoDespesa2" placeholder="00/00/0000" required>
                            </div>
