<%-- 
    Document   : eventoFiltroRel
    Created on : 07/05/2020, 17:23:40
    Author     : João Pedro
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../custom/css/paginaDeRelatorios/relatorioEvento/eventoFiltroRel.css">
    </head>
    <body>
        <!-- NavBar -->
        ...
        <br>
        <form method="GET" action="relatorioEvento">
            Status do Evento:
