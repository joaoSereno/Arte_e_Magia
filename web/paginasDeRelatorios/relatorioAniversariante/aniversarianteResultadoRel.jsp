<%-- 
    Document   : aniversarianteResultadoRel
    Created on : 07/05/2020, 17:25:12
    Author     : João Pedro
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../custom/css/paginaDeRelatorios/relatorioAniversariante/aniversarianteResultadoRel.css">
    </head>
    <body>
        <!-- NavBar -->
