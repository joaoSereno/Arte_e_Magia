<%-- 
    Document   : funcionarioResultadoRel
    Created on : 07/05/2020, 17:25:33
    Author     : João Pedro
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../custom/css/paginaDeRelatorios/relatorioFuncionario/funcionarioResultadoRel.css">
    </head>
    <body>
        <!-- NavBar -->
                ...
                <div class="col-sm-12 col-md-8 col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 my-1">
                            ...
                            <h4>Quantidade de Evento: ${totalEventoPeriodo}</h4>
                 
                        </div>
                        
                        <div class="col-lg-6 my-1">
                        
                            <h4>Valor Total Pago: R$ ${totalValorPagoFunc}</h4>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8">
                    ...
                    <div class="form-col-lg-8 my-2">
                        ...
                        <a  class="btn btn-secondary btn-lg btn-block" href="funcionarioFiltroRel.jsp">Voltar</a> 
