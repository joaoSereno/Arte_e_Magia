...
public class TelefoneSQL extends Conexao{
    ...
    /**
     * Método que realiza insert na tabela "telefone" do banco de dados e caso venha com o atributo isPrincipal = true, realiza o update no ultimo registro que esteja como isPrincipal = true
     * @param telefone
     * @throws Exception 
     */
    ...
    /**
     * Método atualiza como false os registro da tabela "telefone" que esteja como isPrincipal=true
     * @param idFuncionario
     * @param idCliente
     * @throws Exception 
     */
    ...
    /**
     * Método que realiza o delete do registro na tabela "telefone" do banco de dados. Caso o telefone seja principal será realizado o delete e depois update para isPrincipal = true para o próximo telefone.
     * @param telefone
     * @throws Exception 
     */
