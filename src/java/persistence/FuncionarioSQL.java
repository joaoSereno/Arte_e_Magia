...
public class FuncionarioSQL extends Conexao { //extende classe de conexão com o banco de dados
    ...
    /**
     * Método que realiza um insert de um registro na tabela "funcionario" do banco de dados.
     * @param funcionario
     * @throws Exception 
     */
    ...
    /**
     * Método que retorna todos os registros da tabela "funcionario" que estejam ativos.
     * @return
     * @throws Exception 
     */
    ...
    /**
     * Método retorna o último registro da tabela "funcionario" do banco de dados.
     * @return
     * @throws Exception 
     */
    ...
    /**
     * Método que inativa o registro de funcionario da tabela "funcionario" , realizando um update ativo = 0.
     * @param idFuncionario
     * @throws Exception 
     */
    ...
    /**
     * Metódo que realiza a edição  de um registro de funcionario especifico da tabela "funcionario".
     * @param idFuncionario
